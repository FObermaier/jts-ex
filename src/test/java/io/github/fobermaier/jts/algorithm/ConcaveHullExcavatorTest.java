...
public class ConcaveHullExcavatorTest extends TestCase {
  ...
  public void testPointsOnLine() throws ParseException {
  ...
  public void testThreeUniquePoints() throws ParseException {
  ...
  private void checkHull(String inputWKT, double tolerance, String expectedWKT) throws ParseException {
  ...
  private static void checkEqual(Geometry expected, Geometry actual) {
